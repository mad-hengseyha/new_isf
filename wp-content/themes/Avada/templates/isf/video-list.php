...
<div class="col-md-4 col-sm-12 mb-40" data-aos="fade-up">
    ...
    <h4 class="mt-20 story-title" id="title_<?php echo get_the_ID(); ?>">
        <?php
    ...
    <div id="iframe_<?php echo get_the_ID(); ?>" class="custom_video d-none position-absolute iframe_<?php echo get_the_ID(); ?>">
