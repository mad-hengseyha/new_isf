...
/**
 * Template Name: Report and Finance Page
 *
 *
 * @package Avada
...
<?php
how_we_work_section($post_id, '', 'header-section', 'header-padding', 'btn-read-more', 'md-column');


//Where our money goes
sfi_where_our_money_go_section($post_id, 'default');

how_we_are_run_section_post($post_id, 'section-padding-mobile pb-40');

// //accordion section Education Programme
isf_education_program_section($post_id, 'section-padding-mobile section-padding-top-mobile pt-40 pb-40');
...
//Where our money goes
sfi_where_our_money_go_section($post_id, 'none');
