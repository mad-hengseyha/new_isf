...
<?php
how_we_work_section($post_id, '', '', 'header-padding', 'btn-read-more');

isf_two_columns_section($post_id, '', '', 'no_revers', 'no_readmore', 'no-sm-40');
...
state_number_three_columns_section($post_id, 'section-padding-mobile pb-40');

// how it start section
isf_show_it_start_section($post_id, 'section-padding-top-mobile section-padding-mobile pt-40 pb-40', 'no_image_title');

//Education Programme
isf_education_program_section($post_id, 'section-padding-top-mobile pt-40');
