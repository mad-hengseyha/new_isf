...
<?php
// foreach ($sharingbox_social_icon_options as $key => $value) {
// 	var_dump($key);
// 	var_dump($value);
// }
echo fusion_library()->social_sharing->render_social_icons($sharingbox_social_icon_options); // phpcs:ignore WordPress.Security.EscapeOutput 
?>
<?php
// }
