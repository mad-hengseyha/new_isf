...
isf_contribute_ways_section($post_id, 'section-padding-top-mobile section-padding-mobile pt-40 pb-40');

//partner ship section
isf_partnership_section($post_id, 'section-padding-top-mobile section-padding-mobile pt-40 pb-40');

// Our amazing fundraisers section
isf_fundraisers_section($post_id, 'section-padding-top-mobile section-padding-mobile pt-40 pb-40');
