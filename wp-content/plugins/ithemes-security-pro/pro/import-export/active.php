...
function itsec_import_export_notification_strings() {
	return array(
		...
		'description' => sprintf( __( 'The %1$sSettings Import Export%2$s module sends an email with the settings export file attached.', 'it-l10n-ithemes-security-pro' ), '<a href="#" data-module-link="import-export">', '</a>' ),
