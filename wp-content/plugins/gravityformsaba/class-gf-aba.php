...
class GFABA extends GFPaymentAddOn
{
	...
	protected $_slug = 'gravityformsaba';
	protected $_path = 'gravityformsaba/aba.php';
	protected $_full_path = __FILE__;
	protected $_url = 'http://www.gravityforms.com';
	protected $_title = 'Gravity Forms ABA Standard Add-On';
	protected $_short_title = 'ABA Payment';
	...
	protected $_capabilities_form_settings = 'gravityforms_aba';
	protected $_capabilities_uninstall = 'gravityforms_aba_uninstall';
	...
	public function styles()
	{
		...
		$styles = array(
			array(
				'handle'  => 'gform_aba_form_settings_css',
	...
	public function feed_settings_fields()
	{
		...
		//Adding custom settings for backwards compatibility with hook 'gform_aba_add_option_group'
		$fields[] = array(
			'name'  => 'custom_options',
			'label' => '',
			'type'  => 'custom',
		...
		/**
		 * Filter through the feed settings fields for the ABA feed
		 *
	...
	public function settings_notifications($field, $echo = true)
	{
		...
		<script type='text/javascript'>
			...
			function ToggleNotifications() {
				...
				var container = jQuery('#gf_aba_notification_container');
...
<?php
	...
	public function redirect_url($feed, $submission_data, $form, $entry)
	{
		...
		$billing_firstname = $feed['meta']['billingInformation_firstName'];
		$billing_lastname = $feed['meta']['billingInformation_lastName'];
	 ...
	 *
	 * Support for page=gf_aba_ipn remains so IPNs will continue to be processed for existing subscriptions.
	 *
	 * @since unknown
	...
	public function admin_edit_payment_transaction_id($transaction_id, $form, $entry)
	{
		...
		$input = '<input type="text" id="aba_transaction_id" name="aba_transaction_id" value="' . $transaction_id . '">';
	...
	/**
	 * Editing of the payment details should only be possible if the entry was processed by ABA, if the payment status is Pending or Processing, and the transaction was not a subscription.
	 *
	 ...
	 *
	 * Transform data when upgrading from legacy ABA.
	 *
	...
	public function upgrade($previous_version)
	{
		...
		if ($previous_is_pre_addon_framework) {
			...
			//copy existing ABA transactions to new table
			$this->copy_transactions();

			//updating payment_gateway entry meta to 'gravityformsaba' from 'aba'
	...
	public static function get_config_by_entry($entry)
	{
		...
		return $feed['addon_slug'] == $aba->_slug ? $feed : false;
	}
