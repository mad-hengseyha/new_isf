...
/**
 * Template Name: ISF Sport Ground Page
 *
 *
 * @package Avada
...
isf_two_columns_section($post_id, '', '', 'no_revers');

//football pitch schedule
isf_football_shedule_section($post_id, 'section-padding-mobile');

//Book ISF Sports Ground
isf_book_sports_ground_section($post_id, 'section-padding-top-mobile section-padding-mobile');
