			...
			<form role="search" method="get" class="searchform bbp-search-form fusion-search-form" action="<?php bbp_search_url(); ?>">
				<div class="fusion-search-form-content">
					...
					<div class="fusion-search-field search-field">
						<input tabindex="<?php bbp_tab_index(); ?>" autocomplete="off" type="text" value="<?php echo esc_attr(bbp_get_search_terms()); ?>" placeholder="<?php esc_html_e('Search the Forum...', 'Avada'); ?>" name="bbp_search" id="bbp_search" />
					</div>
