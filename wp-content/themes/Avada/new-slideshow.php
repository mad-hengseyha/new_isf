	...
	<div class="fusion-flexslider flexslider fusion-flexslider-loading fusion-post-slideshow">
		<ul class="slides">
			...
			<?php if (has_post_thumbnail()) : ?>
				<?php if (is_search()) : ?>
					<li><?php echo fusion_render_first_featured_image_markup($post->ID, $size, $permalink, false, false, true); // phpcs:ignore WordPress.Security.EscapeOutput 
						?></li>
				<?php else : ?>
					<li><?php echo fusion_render_first_featured_image_markup($post->ID, $size, $permalink); // phpcs:ignore WordPress.Security.EscapeOutput 
						?></li>
				<?php endif; ?>
			<?php endif; ?>
			<?php $i = 2; ?>
