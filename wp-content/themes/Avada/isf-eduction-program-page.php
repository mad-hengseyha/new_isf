...
/**
 * Template Name: Our Education Programme
 *
 *
 * @package Avada
...
isf_education_program_impact_section($post_id, 'section-padding-mobile pb-40');

isf_two_columns_section($post_id, 'align-items-center lg-mb-20', 'section-padding-top-mobile section-padding-mobile pt-40 pb-40', '', '', 'custom-read-more-btn');
